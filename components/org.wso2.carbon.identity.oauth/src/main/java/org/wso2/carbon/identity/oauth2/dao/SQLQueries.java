...
public class SQLQueries {
    ...
    public static final String UPDATE_REFRESH_TOKEN_VALIDITY_STATE_AND_STATE_ID =
            "UPDATE IDN_OAUTH2_ACCESS_TOKEN SET REFRESH_TOKEN_VALIDITY_PERIOD=?, TOKEN_STATE=?, " +
                    "TOKEN_STATE_ID=? WHERE TOKEN_ID=?";

    public static final String RETRIEVE_ACTIVE_ACCESS_TOKENS_BY_CONSUMER_USER_SCOPE_BINDING =
            "SELECT ACCESS_TOKEN, TOKEN_ID, TIME_CREATED, REFRESH_TOKEN_TIME_CREATED, VALIDITY_PERIOD, " +
                    "REFRESH_TOKEN_VALIDITY_PERIOD" +
            " FROM IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS " +
            "WHERE CONSUMER_KEY = ? " +
            "AND TENANT_ID = ?) AND AUTHZ_USER = ? AND TENANT_ID = ? AND USER_DOMAIN = ? " +
            "AND TOKEN_SCOPE_HASH = ? AND TOKEN_BINDING_REF = ? AND AUTHORIZED_ORGANIZATION = ? " +
            "AND TOKEN_STATE IN ('ACTIVE', 'GRACEFULLY_ROTATED')";
    ...
    public static final String GET_DISTINCT_APPS_WITH_APP_TENANT_AUTHORIZED_BY_USER_ALL_TIME =
            "SELECT DISTINCT CONSUMER_KEY, IDN_OAUTH_CONSUMER_APPS.TENANT_ID FROM IDN_OAUTH2_ACCESS_TOKEN " +
            "JOIN IDN_OAUTH_CONSUMER_APPS ON CONSUMER_KEY_ID = ID WHERE AUTHZ_USER=? AND " +
            "IDN_OAUTH2_ACCESS_TOKEN.TENANT_ID=? AND IDN_OAUTH2_ACCESS_TOKEN.USER_DOMAIN=? " +
            "AND (TOKEN_STATE='ACTIVE' OR TOKEN_STATE='EXPIRED')";
    ...
    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_IDP_NAME_WITH_CONSENTED_TOKEN_MYSQL =
            "SELECT ACCESS_TOKEN, " +
            "AUTHZ_USER, ACCESS_TOKEN_SELECTED.TENANT_ID, USER_DOMAIN, TOKEN_SCOPE, TOKEN_STATE, " +
            "REFRESH_TOKEN_TIME_CREATED, REFRESH_TOKEN_VALIDITY_PERIOD, ACCESS_TOKEN_SELECTED.TOKEN_ID, GRANT_TYPE, " +
            "SUBJECT_IDENTIFIER, TOKEN_BINDING_REF, TIME_CREATED, VALIDITY_PERIOD, AUTHORIZED_ORGANIZATION, " +
            "IDP.NAME, CONSENTED_TOKEN " +
            "FROM ( SELECT ACCESS_TOKEN, AUTHZ_USER, TENANT_ID, USER_DOMAIN, TOKEN_STATE, REFRESH_TOKEN_TIME_CREATED," +
            " REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER, IDP_ID, TOKEN_BINDING_REF," +
            " TIME_CREATED, VALIDITY_PERIOD, AUTHORIZED_ORGANIZATION, CONSENTED_TOKEN " +
            "FROM IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY_ID = " +
            "(SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ? AND TENANT_ID = ?) " +
            "AND REFRESH_TOKEN_HASH = ? ORDER BY TIME_CREATED DESC, TOKEN_STATE LIMIT 1) ACCESS_TOKEN_SELECTED " +
            "LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE " +
    ...
    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_IDP_NAME_WITH_CONSENTED_TOKEN_DB2SQL =
            "SELECT ACCESS_TOKEN, AUTHZ_USER, " +
            "ACCESS_TOKEN_SELECTED.TENANT_ID, USER_DOMAIN, TOKEN_SCOPE, TOKEN_STATE, REFRESH_TOKEN_TIME_CREATED, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, ACCESS_TOKEN_SELECTED.TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER, " +
            "TOKEN_BINDING_REF, TIME_CREATED, VALIDITY_PERIOD, AUTHORIZED_ORGANIZATION, IDP.NAME, CONSENTED_TOKEN " +
            "FROM ( SELECT ACCESS_TOKEN, AUTHZ_USER, TENANT_ID, USER_DOMAIN, TOKEN_STATE, REFRESH_TOKEN_TIME_CREATED," +
            " REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER, IDP_ID, TOKEN_BINDING_REF, " +
            "TIME_CREATED, VALIDITY_PERIOD, AUTHORIZED_ORGANIZATION, CONSENTED_TOKEN " +
            "FROM IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY_ID = " +
    ...
    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_IDP_NAME_WITH_CONSENTED_TOKEN_ORACLE =
            "SELECT ACCESS_TOKEN, AUTHZ_USER, " +
            "ACCESS_TOKEN_SELECTED.TENANT_ID, USER_DOMAIN, TOKEN_SCOPE, TOKEN_STATE, REFRESH_TOKEN_TIME_CREATED, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, ACCESS_TOKEN_SELECTED.TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER, " +
            "TOKEN_BINDING_REF, TIME_CREATED, VALIDITY_PERIOD, AUTHORIZED_ORGANIZATION, IDP.NAME, CONSENTED_TOKEN " +
            "FROM (SELECT * FROM (SELECT ACCESS_TOKEN, AUTHZ_USER, TENANT_ID, USER_DOMAIN, TOKEN_STATE, " +
            "REFRESH_TOKEN_TIME_CREATED, REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER, " +
            "IDP_ID, TOKEN_BINDING_REF, TIME_CREATED, VALIDITY_PERIOD, AUTHORIZED_ORGANIZATION, CONSENTED_TOKEN " +
            "FROM IDN_OAUTH2_ACCESS_TOKEN WHERE " +
            "CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ? AND TENANT_ID = ?) " +
            "AND REFRESH_TOKEN_HASH = ? ORDER BY TIME_CREATED DESC) WHERE ROWNUM < 2 ) " +
            "ACCESS_TOKEN_SELECTED LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE ON ACCESS_TOKEN_SELECTED.TOKEN_ID = " +
    ...
    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_IDP_NAME_WITH_CONSENTED_TOKEN_MSSQL =
            "SELECT ACCESS_TOKEN, " +
            "AUTHZ_USER, ACCESS_TOKEN_SELECTED.TENANT_ID, USER_DOMAIN, TOKEN_SCOPE, TOKEN_STATE, " +
            "REFRESH_TOKEN_TIME_CREATED, REFRESH_TOKEN_VALIDITY_PERIOD, ACCESS_TOKEN_SELECTED.TOKEN_ID, GRANT_TYPE, " +
            "SUBJECT_IDENTIFIER, TOKEN_BINDING_REF, TIME_CREATED, VALIDITY_PERIOD, AUTHORIZED_ORGANIZATION, " +
    ...
    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_WITH_EXTENDED_ATTRIBUTES_CONSENTED_MSSQL =
            "SELECT ACCESS_TOKEN, AUTHZ_USER, ACCESS_TOKEN_SELECTED.TENANT_ID, USER_DOMAIN, " +
            "TOKEN_SCOPE, TOKEN_STATE, " +
            "REFRESH_TOKEN_TIME_CREATED, REFRESH_TOKEN_VALIDITY_PERIOD, ACCESS_TOKEN_SELECTED.TOKEN_ID, GRANT_TYPE, " +
            "SUBJECT_IDENTIFIER, TOKEN_BINDING_REF, TIME_CREATED, VALIDITY_PERIOD, AUTHORIZED_ORGANIZATION, " +
            "IDP.NAME, TOKEN_ATTR_NAME, TOKEN_ATTR_VALUE, CONSENTED_TOKEN " +
            "FROM (SELECT TOP 1 ACCESS_TOKEN, AUTHZ_USER, TENANT_ID, USER_DOMAIN, TOKEN_STATE, " +
            "REFRESH_TOKEN_TIME_CREATED, REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER, " +
            "IDP_ID, TOKEN_BINDING_REF, TIME_CREATED, VALIDITY_PERIOD, AUTHORIZED_ORGANIZATION, CONSENTED_TOKEN " +
            "FROM IDN_OAUTH2_ACCESS_TOKEN " +
    ...
    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_WITH_EXTENDED_ATTRIBUTES_CONSENTED_MYSQL =
            "SELECT ACCESS_TOKEN, AUTHZ_USER, ACCESS_TOKEN_SELECTED.TENANT_ID, USER_DOMAIN, " +
            "TOKEN_SCOPE, TOKEN_STATE, " +
            "REFRESH_TOKEN_TIME_CREATED, REFRESH_TOKEN_VALIDITY_PERIOD, ACCESS_TOKEN_SELECTED.TOKEN_ID, GRANT_TYPE, " +
            "SUBJECT_IDENTIFIER, TOKEN_BINDING_REF, TIME_CREATED, VALIDITY_PERIOD, AUTHORIZED_ORGANIZATION, " +
            "IDP.NAME, TOKEN_ATTR_NAME, TOKEN_ATTR_VALUE, CONSENTED_TOKEN " +
            "FROM (SELECT ACCESS_TOKEN, AUTHZ_USER, TENANT_ID, USER_DOMAIN, TOKEN_STATE, " +
            "REFRESH_TOKEN_TIME_CREATED, REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER, " +
            "IDP_ID, TOKEN_BINDING_REF, TIME_CREATED, VALIDITY_PERIOD, AUTHORIZED_ORGANIZATION, CONSENTED_TOKEN " +
            "FROM IDN_OAUTH2_ACCESS_TOKEN WHERE " +
            "CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ? AND TENANT_ID = ?) " +
    ...
    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_WITH_EXTENDED_ATTRIBUTES_CONSENTED_DB2SQL =
            "SELECT ACCESS_TOKEN, AUTHZ_USER, " +
            "ACCESS_TOKEN_SELECTED.TENANT_ID, USER_DOMAIN, TOKEN_SCOPE, TOKEN_STATE, REFRESH_TOKEN_TIME_CREATED, " +
            "REFRESH_TOKEN_VALIDITY_PERIOD, ACCESS_TOKEN_SELECTED.TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER, " +
            "TOKEN_BINDING_REF, TIME_CREATED, VALIDITY_PERIOD, AUTHORIZED_ORGANIZATION, IDP.NAME, TOKEN_ATTR_NAME, " +
            "TOKEN_ATTR_VALUE, CONSENTED_TOKEN FROM ( SELECT ACCESS_TOKEN, AUTHZ_USER, TENANT_ID, USER_DOMAIN, " +
            "TOKEN_STATE, REFRESH_TOKEN_TIME_CREATED, REFRESH_TOKEN_VALIDITY_PERIOD, " +
            "TOKEN_ID, GRANT_TYPE, SUBJECT_IDENTIFIER, IDP_ID, TOKEN_BINDING_REF, TIME_CREATED, VALIDITY_PERIOD, " +
            "AUTHORIZED_ORGANIZATION, CONSENTED_TOKEN " +
            "FROM IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY_ID = (SELECT ID FROM IDN_OAUTH_CONSUMER_APPS " +
            "WHERE CONSUMER_KEY = ? AND TENANT_ID = ?) AND REFRESH_TOKEN_HASH = ? ORDER BY " +
            "TIME_CREATED DESC FETCH FIRST 1 ROWS ONLY) ACCESS_TOKEN_SELECTED " +
            "LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE " +
    ...
    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_WITH_EXTENDED_ATTRIBUTES_CONSENTED_POSTGRESQL =
            "SELECT ACCESS_TOKEN, AUTHZ_USER, ACCESS_TOKEN_SELECTED.TENANT_ID, USER_DOMAIN, " +
            "TOKEN_SCOPE, TOKEN_STATE, " +
            "REFRESH_TOKEN_TIME_CREATED, REFRESH_TOKEN_VALIDITY_PERIOD, ACCESS_TOKEN_SELECTED.TOKEN_ID, GRANT_TYPE, " +
            "SUBJECT_IDENTIFIER, TOKEN_BINDING_REF, TIME_CREATED, VALIDITY_PERIOD, AUTHORIZED_ORGANIZATION, " +
    ...
    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_WITH_EXTENDED_ATTRIBUTES_CONSENTED_INFORMIX =
            "SELECT ACCESS_TOKEN, AUTHZ_USER, ACCESS_TOKEN_SELECTED.TENANT_ID, USER_DOMAIN, " +
            "TOKEN_SCOPE, TOKEN_STATE, " +
            "REFRESH_TOKEN_TIME_CREATED, REFRESH_TOKEN_VALIDITY_PERIOD, ACCESS_TOKEN_SELECTED.TOKEN_ID, GRANT_TYPE, " +
            "SUBJECT_IDENTIFIER, TOKEN_BINDING_REF, TIME_CREATED, VALIDITY_PERIOD, AUTHORIZED_ORGANIZATION, " +
    ...
    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_WITH_EXTENDED_ATTRIBUTES_CONSENTED_ORACLE =
            "SELECT ACCESS_TOKEN, AUTHZ_USER, ACCESS_TOKEN_SELECTED.TENANT_ID, USER_DOMAIN, " +
            "TOKEN_SCOPE, TOKEN_STATE, " +
            "REFRESH_TOKEN_TIME_CREATED, REFRESH_TOKEN_VALIDITY_PERIOD, ACCESS_TOKEN_SELECTED.TOKEN_ID, GRANT_TYPE, " +
            "SUBJECT_IDENTIFIER, TOKEN_BINDING_REF, TIME_CREATED, VALIDITY_PERIOD, AUTHORIZED_ORGANIZATION, " +
            "IDP.NAME, TOKEN_ATTR_NAME, TOKEN_ATTR_VALUE, CONSENTED_TOKEN " +
            "FROM (SELECT * FROM (SELECT ACCESS_TOKEN, AUTHZ_USER, TENANT_ID, USER_DOMAIN, " +
            "TOKEN_STATE, REFRESH_TOKEN_TIME_CREATED, REFRESH_TOKEN_VALIDITY_PERIOD, TOKEN_ID, GRANT_TYPE, " +
            "SUBJECT_IDENTIFIER, IDP_ID, TOKEN_BINDING_REF, TIME_CREATED, VALIDITY_PERIOD, AUTHORIZED_ORGANIZATION, " +
            "CONSENTED_TOKEN FROM IDN_OAUTH2_ACCESS_TOKEN WHERE CONSUMER_KEY_ID = " +
            "(SELECT ID FROM IDN_OAUTH_CONSUMER_APPS WHERE CONSUMER_KEY = ? AND TENANT_ID = ?) AND " +
            "REFRESH_TOKEN_HASH = ? ORDER BY TIME_CREATED DESC) WHERE ROWNUM < 2 ) ACCESS_TOKEN_SELECTED " +
            "LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_SCOPE ON " +
            "ACCESS_TOKEN_SELECTED.TOKEN_ID = IDN_OAUTH2_ACCESS_TOKEN_SCOPE.TOKEN_ID JOIN IDP ON IDP_ID=IDP.ID " +
            "LEFT JOIN IDN_OAUTH2_ACCESS_TOKEN_ATTRIBUTES ON ACCESS_TOKEN_SELECTED.TOKEN_ID = " +
            "IDN_OAUTH2_ACCESS_TOKEN_ATTRIBUTES.TOKEN_ID";
    ...
    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_IDP_NAME_WITH_CONSENTED_TOKEN_POSTGRESQL =
            "SELECT ACCESS_TOKEN, " +
            "AUTHZ_USER, ACCESS_TOKEN_SELECTED.TENANT_ID, USER_DOMAIN, TOKEN_SCOPE, TOKEN_STATE, " +
            "REFRESH_TOKEN_TIME_CREATED, REFRESH_TOKEN_VALIDITY_PERIOD, ACCESS_TOKEN_SELECTED.TOKEN_ID, GRANT_TYPE, " +
            "SUBJECT_IDENTIFIER, TOKEN_BINDING_REF, TIME_CREATED, VALIDITY_PERIOD, AUTHORIZED_ORGANIZATION, " +
    ...
    public static final String RETRIEVE_ACCESS_TOKEN_VALIDATION_DATA_IDP_NAME_WITH_CONSENTED_TOKEN_INFORMIX =
            "SELECT ACCESS_TOKEN, " +
            "AUTHZ_USER, ACCESS_TOKEN_SELECTED.TENANT_ID, USER_DOMAIN, TOKEN_SCOPE, TOKEN_STATE, " +
            "REFRESH_TOKEN_TIME_CREATED, REFRESH_TOKEN_VALIDITY_PERIOD, ACCESS_TOKEN_SELECTED.TOKEN_ID, GRANT_TYPE, " +
            "SUBJECT_IDENTIFIER, TOKEN_BINDING_REF, TIME_CREATED, VALIDITY_PERIOD, AUTHORIZED_ORGANIZATION, " +
    ...
    public static final String UPDATE_OAUTH2_ACCESS_TOKEN_ATTRIBUTE_VALUE =
            "UPDATE IDN_OAUTH2_ACCESS_TOKEN_ATTRIBUTES SET TOKEN_ATTR_VALUE = ? " +
                    "WHERE TOKEN_ID = ? AND TOKEN_ATTR_NAME = ?";
    ...
    public static final String GET_ACCESS_TOKEN_EXTENDED_ATTRIBUTE_VALUE =
            "SELECT TOKEN_ATTR_VALUE FROM IDN_OAUTH2_ACCESS_TOKEN_ATTRIBUTES WHERE TOKEN_ID = ? " +
                    "AND TOKEN_ATTR_NAME = ?";
    ...
    public static class RefreshTokenPersistenceSQLQueries {
        ...
        public static final String UPDATE_REFRESH_TOKEN_VALIDITY_PERIOD =
                "UPDATE IDN_OAUTH2_REFRESH_TOKEN SET REFRESH_TOKEN_VALIDITY_PERIOD=? WHERE REFRESH_TOKEN_ID=?";
